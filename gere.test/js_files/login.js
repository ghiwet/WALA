...
function _mod_defaultCard12(module) {
    ...
    DefaultCard.prototype.preRender = function preRender() {
...
function _mod_Controller13(module) {
    ...
    Controller.prototype.setupConfig = function () {
        ...
        var cachedConfigPromise = new Promise(function (resolve, reject) {
        ...
        return cachedConfigPromise.then(setConfig, function () {
    ...
    Controller.prototype.platformInit = function platformInit() {
       ...
       self.setupConfig().then(function () {
            self.init();
            self.setupListeners();
            if (self.card) {
    ...
    Controller.prototype.display = function display(options) {
        ...
        return self.card.preRender().then(function test123() {
    ...
    Controller.prototype.navigateTo = function (target, document, extra) {
        ...
        console.appDebug(DBG, 'navigateTo arguments:', arguments);
        var self = this;
        self.getTargetForName(target).then(function (contOption) {
    ...
    Controller.prototype.getTargetForName = function (name) {
        var config = cache.get(name);
        if (config) {
            return Promise.resolve(config);
        }
        var db = _mod_db10({ exports: {} });
        return db.query('app/controller', { key: name }).then(function (result) {
...
function _mod_Dbw14(module) {
    ...
    DBW.prototype.putLocal = function (doc) {
...
function _mod_Dbr15(module) {
    ...
    DBR.prototype.query = function (fun) {
    ...
    DBR.prototype.getLocal = function (docId) {
...
function _mod_User16(module) {
    ...
    User.prototype.login = function janusUserLogin(credentials) {
...
function _mod_utility20(module) {
    ...
    exports.allRejects = function (promises) {
        return new Promise(function (resolve, reject) {
            var values = [];
            var rejects = [];
...
function _mod_User24(module) {
    ...
    User.prototype.login = function userLogin(credentials) {
        var self = this;
        console.appDebug(DBG, 'login arguments:', arguments);
        var args = arguments;
        var promise = new Promise(function (resolve, reject) {
            NativeUser.prototype.login.apply(self, args).then(function (response) {
...
function _mod_login25(module) {
    ...
    LoginController.prototype.prepareData = function prepareData() {
        var self = this;
        if (appversion.lt('2.1.1')) {
            ...
            db = new Db('appdb');
            return new Promise(function (resolve, reject) {
                self.tryAutologin().then(function () {
                    reject();
                    self.screen.navigateTo('home');
                }, function () {
                    self.mapFields().then(function () {
    ...
    LoginController.prototype.tryAutologin = function tryAutologin() {
        console.appDebug(DBG, 'tryAutologin');
        var self = this;
        return new Promise(function (resolve, reject) {
            db.getLocal(LOGINCACHE_DOCID).then(function (data) {
                ...
                if (data && !!data.autologin && !!data.login && !!data.password) {
                    ...
                    self.login(data.login, data.password, true).then(function () {
    ...
    LoginController.prototype.login = function loginLoginController(login, password, saveCredentials) {
        ...
        return user.login({
            ...
            self.updateSavedCredentials(saveCredentials, saveCredentials ? login : '', saveCredentials ? password : '').then(function () {
    ...
    LoginController.prototype.updateSavedCredentials = function (autologin, login, password) {
    ...
    LoginController.prototype.saveSettings = function () {
        ...
        db.putLocal(this.loginSettings);
    };
    LoginController.prototype.mapFields = function () {
        var self = this;
        console.appDebug(DBG, Object.keys(this.card.data));
        console.appDebug(DBG, this.data);
        return db.getLocal(LOGINSETTIGS_DOCID).then(function (doc) {
    ...
    LoginController.prototype.onLoginClick = function onLoginClick() {
        ...
        self.login(self.card.data.Login.value, self.card.data.Password.value, self.card.data.SaveCredentials.value).then(function () {
            self.screen.navigateTo('home');
            hideProgress();
        }, function (err) {
